...
int main(int argc, char **argv) {
    ...
    /*
     * MPI_Allreduce combines all local sums
     * and gives the final result to EVERY process.
     */
    ...
    /*
     * Every process can now use total_sum.
     */
    double percentage =
    ...
    /*
     * Verification is performed only by root.
     */
    if (rank == 0) {
